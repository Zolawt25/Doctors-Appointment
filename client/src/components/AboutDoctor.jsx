  ...
  return (
    <div className='doctorPageAbout'>
        ...
        <div className='doctorPageAboutEducation'>
            <div className='doctorPageAboutEducationCont'>
                <p className='doctorPageAboutEducationYear'>2008-2010</p>
                <p className='doctorPageAboutEducationDeg'>Bsc degree in Neurosciences</p>
            </div>
            <p className='doctorPageAboutEducationColl'>New Apollo hospital</p>
        </div>
        <div className='doctorPageAboutEducation'>
            <div className='doctorPageAboutEducationCont'>
                <p className='doctorPageAboutEducationYear'>2011-2015</p>
                <p className='doctorPageAboutEducationDeg'>Royall College of physicians</p>
            </div>
            <p className='doctorPageAboutEducationColl'>University College London</p>
        </div>
        <div className='doctorPageAboutEducation'>
            <div className='doctorPageAboutEducationCont'>
                <p className='doctorPageAboutEducationYear'>20016-2017</p>
                <p className='doctorPageAboutEducationDeg'>PHD</p>
            </div>
            <p className='doctorPageAboutEducationColl'>University College London</p>
        </div>
    </div>
